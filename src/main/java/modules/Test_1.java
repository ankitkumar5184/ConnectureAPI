...
public class Test_1 extends BaseClass{
    ...
    public void test1_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test1_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test1_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test1_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test1_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
