...
public class Test_8 extends BaseClass{

    @Test()
    @Description("Adding Pharmacies to session")
    public void test8_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test8_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test8_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test8_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test8_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
