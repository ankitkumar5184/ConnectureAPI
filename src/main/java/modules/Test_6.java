...
public class Test_6 extends BaseClass{

    @Test()
    @Description("Adding Pharmacies to session")
    public void test6_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test6_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test6_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test6_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test6_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
