...
public class Test_3 extends BaseClass{
    ...
    public void test3_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test3_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test3_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test3_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test3_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
