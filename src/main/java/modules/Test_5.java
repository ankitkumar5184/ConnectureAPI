...
public class Test_5 extends BaseClass{

    @Test()
    @Description("Adding Pharmacies to session")
    public void test5_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test5_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test5_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test5_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test5_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
