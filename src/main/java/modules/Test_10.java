...
public class Test_10 extends BaseClass{

    @Test()
    @Description("Adding Pharmacies to session")
    public void test10_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test10_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test10_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test10_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test10_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
