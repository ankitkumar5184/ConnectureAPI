...
public class Test_7 extends BaseClass{

    @Test()
    @Description("Adding Pharmacies to session")
    public void test7_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test7_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test7_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test7_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test7_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
