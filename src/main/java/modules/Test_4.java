...
public class Test_4 extends BaseClass{
    ...
    public void test4_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test4_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test4_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test4_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test4_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
