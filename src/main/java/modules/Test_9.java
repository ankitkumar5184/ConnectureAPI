...
public class Test_9 extends BaseClass{

    @Test()
    @Description("Adding Pharmacies to session")
    public void test9_addPharmaciesToSession(){
        createToken();
        generateSessionId();
    ...
    @Test(dependsOnMethods = {"test9_addPharmaciesToSession"})
    @Description("GET Request Operation")
    public void test9_getPharmacy() {
        RestAssured.baseURI = prop.getProperty("host");
...
//        System.out.println(responseBody);
    ...
    @Test(dependsOnMethods = {"test9_getPharmacy"})
    @Description("Updating the Pharmacies")
    public void test9_updatingPharmaciesToSession(){
        RestAssured.baseURI = prop.getProperty("host");
